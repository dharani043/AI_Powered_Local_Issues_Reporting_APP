...
export function CorporationAdminLogin() {
  const { login } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!success) {
        alert('Invalid credentials or corporation details');
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Corporation Admin</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? 'Logging in...' : 'Login as Corporation Admin'}
          </button>
        </form>
